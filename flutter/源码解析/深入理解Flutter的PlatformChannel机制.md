...
Window.dart中的_sendPlatformMessage()最终对应于引擎层中window.cc的_SendPlatformMessage()方法，为了更好理解引擎中的调用关系，见如下**[Enggine核心类图](http://gityuan.com/img/flutter_boot/ClassEngine.jpg)**
